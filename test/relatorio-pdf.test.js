...
|---|---|---:|---|
| 1 | Cabimento e endereçamento | 2,00/2,00 | A peça e o órgão destinatário correspondem ao gabarito. |
| 2 | Tempestividade e legitimidade | 1,00/1,00 | O prazo e a capacidade postulatória foram reconhecidos. |
| 3 | Fatos e síntese | 1,00/1,00 | A síntese preservou os fatos juridicamente relevantes. |
| 4 | Fundamentação e teses | 2,00/3,00 | A tese principal está correta, mas faltou aprofundar a subsidiária. |
| 5 | Pedidos | 1,00/1,50 | O pedido principal foi formulado; o subsidiário ficou incompleto. |
| 6 | Técnica, linguagem e forma | 1,00/1,50 | A redação é clara, com desconto pelo fechamento incompleto. |
...
const dados = { aluno: 'Maria da Silva', matricula: '20260001', turma: 'Estágio II - Turma A', rodada: 1, nomePeca: 'Apelação Criminal', nota: 8, data: '09/08/2026 14:30:00', relatorio, recurso: { resultado: 'Deferido parcialmente', notaAnterior: 7.5, decisao: 'O item de fundamentação foi revisto parcialmente; os demais descontos foram mantidos segundo o espelho.' } };
...
assert.match(html, /padrão OAB\/FGV/i);
